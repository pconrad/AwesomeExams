...
function pythonStringSlice(randomStream)
{
    var nameArray = ["Malibu", "Ventura", "Goleta", "Lompoc",
                     "Oxnard", "Montecido", "Camarillo", "Moorpark"];
    ...
    this.index1 = randomStream.nextIntRange(index2+1);//if index1=0, print nothing
    this.index = 0;
